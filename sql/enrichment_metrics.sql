-- One-time DDL for enrichment metrics (Symphony_dev).
-- Prefer: python scripts/load_enrichment_metrics.py
-- This file is for SSMS. Run the Python loader to also insert the JSONL ledger.
